    ...
    <div>
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-4 ps-card !p-2 max-h-[700px] overflow-y-auto">
          {sessions.map((s, i) => (
            <div key={s.id} onClick={() => setSel(i)} className={`p-3 cursor-pointer rounded border-l-2 mb-1 ${i===sel ? "bg-lime-dim/30 border-lime" : `border-${s.status==="threat"?"threat":"graphite"} hover:bg-charcoal`}`}>
        ...
        <div className="col-span-8 ps-card">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-2">
              <button className="btn btn-secondary !text-xs">Export .pcap</button>
